...
void readCredentials()
{
    ...
    readFromSerial("Enter your Wi-Fi SSID: ", ssid, SSID_LEN, 0);
    EEPROMWrite(ssidAddr, ssid, strlen(ssid));

    readFromSerial("Enter your Wi-Fi password: ", pass, PASS_LEN, 0);
    EEPROMWrite(passAddr, pass, strlen(pass));

    readFromSerial("Enter your Azure IoT hub device connection string: ", connectionString, CONNECTION_STRING_LEN, 0);
...
{
    char result = 'n';
    readFromSerial("Do you need re-configur your WiFi/Azure IoT information?(Auto skip this after 5 seconds)[Y/n]", &result, 1, 5000);
